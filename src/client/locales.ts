...
export const en: Record<MoliCardLocaleKey, string> = {
  ...
  timeoutMsHint: 'Total deadline budget for a single fetch operation. Aligns with tool-web fetchTimeoutMs (default: 60000ms).',
  timeoutMsPlaceholder: '(default: 60000)',
...
export const zh: Record<MoliCardLocaleKey, string> = {
  ...
  timeoutMs: '抓取超时预算 (ms)',
  timeoutMsHint: '单次抓取的最大超时预算（毫秒），对齐 tool-web 的 fetchTimeoutMs（默认 60000ms）。',
  timeoutMsPlaceholder: '（默认：60000）',
