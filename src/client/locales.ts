...
export const en: Record<MoliCardLocaleKey, string> = {
  ...
  autoScrollSentinelHint: 'Enables native CDP micro-clip layout materialization and scrollIntoViewIfNeeded to dynamically load infinite card lists.',
...
export const zh: Record<MoliCardLocaleKey, string> = {
  ...
  autoScrollSentinelHint: '开启原生 CDP Micro-Clip 排版物化与 scrollIntoViewIfNeeded 动态滚动，自动加载全部无限瀑布流卡片。',
