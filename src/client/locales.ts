...
export const en: Record<MoliCardLocaleKey, string> = {
  ...
  autoScrollSentinel: 'Deep container scrolling',
  autoScrollSentinelHint: 'Automatically discovers scrollable DOM containers and scrolls to load infinite lists, lazy-loaded cards, and dynamic pages.',
...
export const zh: Record<MoliCardLocaleKey, string> = {
  ...
  autoScrollSentinel: '深层容器感知滚动',
  autoScrollSentinelHint: '自动发现页面中所有具备滚动能力的深层 DOM 容器，触发展开无限瀑布流、懒加载卡片与动态分页。',
